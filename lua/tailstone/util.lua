local hsluv = require("tailstone.hsluv")
...
-- local ns = vim.api.nvim_create_namespace("tailstone")
...
function util.debug(colors)
  colors = colors or require("tailstone.colors")
  -- Dump unused colors
...
function util.onColorScheme()
  if vim.g.colors_name ~= "tailstone" then
    vim.cmd([[autocmd! tailstone]])
    vim.cmd([[augroup! tailstone]])
  end
end
...
function util.autocmds(config)
  vim.cmd([[augroup tailstone]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorScheme * lua require("tailstone.util").onColorScheme()]])
  if config.dev then
    vim.cmd([[  autocmd BufWritePost */lua/tailstone/** nested colorscheme tailstone]])
  end
